...
abstract public class Circuit implements TransitiveObserver {
    ...
    public static int counter_XOR = 0;
    public static int counter_AND = 0;
    public static int counter_OR = 0;
    public static int counter_NOT = 0;
    public static int counter_shift= 0;

    public static int exeCounter = 0;
